# ┌─────────────────────────────────────────────────────────────────────────────┐
# │ Stage 1: Build FFmpeg with NVIDIA GPU, VAAPI & sndio support               │
# └─────────────────────────────────────────────────────────────────────────────┘
...
RUN apt-get update \
 && apt-get install -y --no-install-recommends \
      ...
      libfreetype6-dev libass-dev libtheora-dev libva-dev \
...
RUN git clone https://git.ffmpeg.org/ffmpeg.git ffmpeg \
 ...
 && ./configure \
      ...
      --enable-libtheora \
      --enable-vaapi --enable-alsa --enable-sndio \
...
# ┌─────────────────────────────────────────────────────────────────────────────┐
# │ Stage 2: Runtime – PyTorch/CUDA, n8n, Whisper                              │
# └─────────────────────────────────────────────────────────────────────────────┘
...
# Minimal runtime + timezone + dependencies
RUN apt-get update \
 && apt-get install -y --no-install-recommends \
...
# Whisper install & pre-download model
